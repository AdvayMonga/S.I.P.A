...
| Web search | built | [web-search.md](design/web-search.md) | `web` server: `web_search` over a swappable `SearchBackend` (Tavily today). Current/external info → sourced research notes. Spawns only when keyed. |
