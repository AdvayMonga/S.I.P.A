...
| Sub-agents | built (fan-out) | [sub-agents.md](design/sub-agents.md) | `delegate` tool → isolated sub-agent loops fanned out in parallel (cap 5, 1-level). Background delegation is the next mode. |
